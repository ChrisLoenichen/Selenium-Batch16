...
public class WindowHandles extends CommonMethods {
    public static void main(String[] args) {
        ...
        //get the window handle of the main page and print on the console
        ...
        // when the focus has shifted to correct page
        System.out.println("the current page under focus is : "+driver.getTitle());

        //after switching to the page google account help,  we can deal with any element we want to in a regular way
